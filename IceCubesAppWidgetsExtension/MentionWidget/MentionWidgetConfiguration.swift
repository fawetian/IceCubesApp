// 文件功能说明：
// 该文件定义了提及小组件的配置意图，允许用户在添加小组件时选择要监控的 Mastodon 账户。提及小组件专门显示用户被其他人提及的通知，功能相对简单，只需要配置账户参数即可。
// 技术点：
...
// 8. 扩展设计 —— 通过扩展添加便利方法。
// 9. 可选参数 —— 支持用户不选择账户的情况。
// 10. 简化配置 —— 配置流程简洁，专注于提及功能。
//
// 技术点详解：
// - 提及专用：专门处理用户被提及的通知，功能专一明确
